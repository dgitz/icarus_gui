...
QT_MOC_LITERAL(9, 120, 19), // "new_firmwaremessage"
QT_MOC_LITERAL(10, 140, 8), // "Firmware"
QT_MOC_LITERAL(11, 149, 23) // "processPendingDatagrams"

    },
    "Receiver\0new_diagnosticmessage\0\0"
    "Diagnostic\0new_devicemessage\0Device\0"
    "new_resourcemessage\0Resource\0"
    "new_armedstatusmessage\0new_firmwaremessage\0"
    "Firmware\0processPendingDatagrams"
};
...
void Receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->new_firmwaremessage((*reinterpret_cast< const Firmware(*)>(_a[1]))); break;
        ...
        {
            typedef void (Receiver::*_t)(const Firmware & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Receiver::new_firmwaremessage)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void Receiver::new_firmwaremessage(const Firmware & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
